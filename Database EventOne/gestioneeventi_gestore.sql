...
CREATE TABLE `gestore` (
  `id` int NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `gestore_ibfk_1` FOREIGN KEY (`id`) REFERENCES `persone` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `gestore` VALUES (4),(10),(14),(15),(18),(19);
...
-- Dump completed on 2024-10-10 15:56:55
