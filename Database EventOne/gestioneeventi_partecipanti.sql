...
CREATE TABLE `partecipanti` (
  ...
  CONSTRAINT `partecipanti_ibfk_1` FOREIGN KEY (`id_utente`) REFERENCES `persone` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `partecipanti_ibfk_2` FOREIGN KEY (`id_evento`) REFERENCES `evento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
